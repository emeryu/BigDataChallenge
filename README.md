...
![](4.Graphs/Elevation.png){ width=50% height=50% } ![](4.Graphs/Latitude.png){ width=50% height=50% } ![](4.Graphs/Longitude.png){ width=50% height=50% } ![](4.Graphs/Temperature.png){ width=50% height=50% }
